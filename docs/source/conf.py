...
version = str(typhos.__version__)
# The full version, including alpha/beta/rc tags.
release = str(typhos.__version__)
...
man_pages = [(master_doc, "typhos", "Typhos Documentation", [author], 1)]
...
intersphinx_mapping = {
    "pcdsdevices": ("https://pcdshub.github.io/pcdsdevices/master/", None),
